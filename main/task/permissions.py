...
class IsAllowedToEditTaskElseNone(permissions.BasePermission):
    """
    Custom permissions for TaskViewSet to only allow the creator editing permissions.
    """
...
class IsAllowedToEditAttachmentElseNone(permissions.BasePermission):
    """
    Custom permissions for AttachmentViewSet to only allow the creator editing permissions.
    """
